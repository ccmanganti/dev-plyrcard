...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--text);font-family:var(--body);overflow-x:hidden}a{color:inherit;text-decoration:none}img{display:block;max-width:100%}.site{position:relative;min-height:100vh;background:radial-gradient(circle at 78% -8%, color-mix(in srgb,var(--brand) 18%,transparent), transparent 30%),#050506}.frame{width:min(1180px,calc(100% - 32px));margin:0 auto}.wrap{width:min(1180px,calc(100% - 32px));margin:0 auto}.nav{height:58px;display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid var(--line);animation:fadeDown .55s ease both}.nav-brand-stack{display:flex;align-items:center;gap:10px;min-width:0}.nav-back-mobile{display:none}.mobile-back-row{display:none}.page-back-mobile{display:none}.nav-brand{display:flex;align-items:center;gap:10px;min-width:0}.nav-brand img{width:30px;height:30px;object-fit:contain}.nav-brand span{font-family:var(--heading);font-size:13px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.plyr-wordmark{display:inline-flex!important;align-items:baseline!important;gap:0!important;font-family:var(--heading)!important;font-weight:900!important;letter-spacing:-.035em!important;line-height:1!important}.plyr-wordmark b{color:#fff!important;font-style:normal!important;font-weight:900!important}.plyr-wordmark em{color:#ff7a1a!important;font-style:normal!important;font-weight:900!important;margin-left:0!important}.nav-actions{display:flex;align-items:center;gap:12px}.nav-link{font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;color:var(--muted)}.nav-link:hover{color:#fff}.btn{height:38px;border:0;border-left:2px solid var(--brand-readable);background:color-mix(in srgb,var(--brand) 26%,#060708);color:#fff;padding:0 16px;font-family:var(--heading);font-size:12px;font-weight:900;letter-spacing:.1em;text-transform:uppercase;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.btn:hover{filter:brightness(1.12)}
        ...
        .saved-card{width:min(900px,calc(100vw - 16px))!important;height:min(88dvh,820px)!important;max-height:min(88dvh,820px)!important;display:flex!important;flex-direction:column!important;overflow:hidden!important}.saved-card .modal-head{flex:0 0 auto!important}.saved-modal-body{padding:10px!important;overflow-y:auto!important;max-height:none!important;flex:1 1 auto!important;-webkit-overflow-scrolling:touch!important}.saved-profile-list{display:grid!important;gap:10px!important;padding-bottom:8px!important}.saved-profile-row{position:relative!important;display:grid!important;grid-template-columns:58px 76px minmax(0,1fr)!important;grid-template-areas:"avatar number copy" "actions actions actions"!important;gap:9px 12px!important;align-items:center!important;padding:11px!important;min-height:106px!important;background:#0d0d10!important;border:1px solid var(--line)!important;color:#fff!important;overflow:hidden!important}.saved-profile-row:before{content:""!important;position:absolute!important;inset:0!important;background:linear-gradient(90deg,color-mix(in srgb,var(--brand) 14%,transparent),transparent 58%)!important;opacity:.72!important;pointer-events:none!important}.saved-profile-row>*{position:relative!important;z-index:2!important}.saved-profile-avatar{grid-area:avatar!important;width:54px!important;height:54px!important;border-radius:999px!important;object-fit:cover!important;background:#17181d!important;display:grid!important;place-items:center!important;color:#fff!important;font-family:var(--heading)!important;font-size:20px!important;font-weight:950!important}.saved-profile-avatar.is-card{width:42px!important;height:58px!important;border-radius:7px!important;object-position:center top!important;justify-self:center!important}.saved-profile-number{grid-area:number!important;display:grid!important;gap:5px!important;min-width:0!important;align-content:center!important}.saved-profile-number strong{font-family:var(--heading)!important;font-size:38px!important;line-height:.82!important;font-weight:950!important;color:#fff!important;letter-spacing:-.05em!important}.saved-profile-number span{font-family:var(--heading)!important;font-size:11px!important;line-height:1!important;font-weight:900!important;letter-spacing:.07em!important;text-transform:uppercase!important;color:var(--brand-readable)!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;display:block!important}.saved-profile-copy{grid-area:copy!important;min-width:0!important;padding-right:0!important;align-self:center!important}.saved-profile-copy strong{display:block!important;font-family:var(--heading)!important;font-size:21px!important;line-height:1.02!important;font-weight:950!important;letter-spacing:.03em!important;text-transform:uppercase!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important}.saved-profile-copy span{display:block!important;margin-top:6px!important;color:rgba(255,255,255,.88)!important;font-size:13px!important;line-height:1.08!important;font-weight:900!important;letter-spacing:.025em!important;text-transform:uppercase!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important}.saved-profile-arrow{display:none!important}.saved-empty-state{padding:24px 14px!important;background:#0d0d10!important;border:1px solid var(--line)!important;color:var(--muted)!important;font-weight:850!important;text-align:center!important}.saved-profile-actions{grid-area:actions!important;display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:6px!important;margin-top:2px!important}.saved-profile-action,.saved-profile-action-form{min-width:0!important;margin:0!important}.saved-profile-action,.saved-profile-action-form button{width:100%!important;min-height:32px!important;border:0!important;border-radius:6px!important;background:#fff!important;color:#050505!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:5px!important;font-family:var(--heading)!important;font-size:8.5px!important;font-weight:900!important;letter-spacing:.02em!important;text-transform:uppercase!important;text-decoration:none!important;cursor:pointer!important;box-shadow:0 3px 8px rgba(0,0,0,.20)!important;padding:0 4px!important}.saved-profile-action.is-remove,.saved-profile-action-form button{background:#fff!important;color:#050505!important}.saved-profile-action.is-disabled{opacity:.42!important;pointer-events:none!important}.saved-profile-action i,.saved-profile-action-form i{font-size:10px!important;color:currentColor!important}.coach-drawer-card.is-loading,.player-quick-save button.is-loading,.saved-profile-action-form button.is-loading{opacity:.7!important;pointer-events:none!important}@media(max-width:420px){.saved-card{width:calc(100vw - 14px)!important;height:calc(100dvh - 90px)!important;max-height:calc(100dvh - 90px)!important}.saved-modal-body{padding:7px!important}.saved-profile-row{grid-template-columns:52px 58px minmax(0,1fr)!important;gap:7px 8px!important;padding:9px!important;min-height:104px!important}.saved-profile-avatar{width:48px!important;height:48px!important}.saved-profile-avatar.is-card{width:36px!important;height:52px!important}.saved-profile-number strong{font-size:32px!important}.saved-profile-number span{font-size:9px!important}.saved-profile-copy strong{font-size:17px!important;line-height:1.05!important}.saved-profile-copy span{font-size:11px!important;line-height:1.1!important}.saved-profile-actions{gap:5px!important}.saved-profile-action,.saved-profile-action-form button{min-height:30px!important;font-size:7.8px!important;padding:0 2px!important}}
            ...
            @if($coachSession)
                ...
                <div class="coach-drawer-grid">
                    ...
                    <form class="coach-drawer-card-form" data-email-watchlist-form method="POST" action="{{ route('clubs.coach-email-watchlist', ['clubSlug' => $club->landing_page_slug]) }}">
                        @csrf
                        <button class="coach-drawer-card" type="submit" data-email-watchlist-button><i class="fa-solid fa-paper-plane"></i><span>Email Watchlist</span></button>
                    </form>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function savedPosition(player){
        const raw = clean(player.position || player.position_full || 'PLYR');
        const map = {
            'goalkeeper':'GK','keeper':'GK','defender':'DEF','center back':'CB','centre back':'CB','center_back':'CB','centre_back':'CB','left back':'LB','left_back':'LB','right back':'RB','right_back':'RB','full back':'FB','full_back':'FB','wing back':'WB','wing_back':'WB',
            'midfielder':'MID','defensive midfielder':'CDM','defensive_midfielder':'CDM','central midfielder':'CM','central_midfielder':'CM','attacking midfielder':'CAM','attacking_midfielder':'CAM','wide midfielder':'WM','wide_midfielder':'WM',
            'forward':'FWD','wide forward':'WF','wide_forward':'WF','striker':'ST','winger':'WG','left wing':'LW','left_wing':'LW','right wing':'RW','right_wing':'RW',
            'point guard':'PG','point_guard':'PG','shooting guard':'SG','shooting_guard':'SG','small forward':'SF','small_forward':'SF','power forward':'PF','power_forward':'PF','center':'C'
        };
        return raw.split(/[|,\/]+/).map(item => {
            const key = item.trim().toLowerCase().replace(/[-_]+/g,' ').replace(/\s+/g,' ');
            if(!key) return '';
            if(map[key]) return map[key];
            const words = key.split(' ').filter(Boolean);
            return words.length > 1 ? words.map(w => w.charAt(0).toUpperCase()).join('') : key.substring(0,4).toUpperCase();
        }).filter(Boolean).filter((v,i,a)=>a.indexOf(v)===i).join(' / ') || 'PLYR';
    }
