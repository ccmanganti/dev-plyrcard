    ...
    <div class="frame">
        <nav class="nav">
            <div class="nav-brand-stack">
                ...
                <a class="nav-back-mobile" href="{{ $club?->landing_page_slug ? route('clubs.landing', ['clubSlug' => $club->landing_page_slug]) : '/' }}"><i class="fa-solid fa-chevron-left"></i> Back to club</a>
            </div>
