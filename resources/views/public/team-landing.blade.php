...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--text);font-family:var(--body);overflow-x:hidden}a{color:inherit;text-decoration:none}img{display:block;max-width:100%}.site{min-height:100vh;background:radial-gradient(circle at 78% -8%, color-mix(in srgb,var(--brand) 18%,transparent), transparent 30%),#050506}.frame{width:min(1180px,calc(100% - 32px));margin:0 auto}.wrap{width:min(1180px,calc(100% - 32px));margin:0 auto}.nav{height:58px;display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid var(--line);animation:fadeDown .55s ease both}.nav-brand{display:flex;align-items:center;gap:10px;min-width:0}.nav-brand img{width:30px;height:30px;object-fit:contain}.nav-brand span{font-family:var(--heading);font-size:13px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nav-actions{display:flex;align-items:center;gap:12px}.nav-link{font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;color:var(--muted)}.nav-link:hover{color:#fff}.btn{height:38px;border:0;border-left:2px solid var(--brand-readable);background:color-mix(in srgb,var(--brand) 26%,#060708);color:#fff;padding:0 16px;font-family:var(--heading);font-size:12px;font-weight:900;letter-spacing:.1em;text-transform:uppercase;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.btn:hover{filter:brightness(1.12)}
        .hero{position:relative;isolation:isolate;min-height:clamp(440px,62vh,660px);display:grid;align-items:end;overflow:hidden;border-bottom:1px solid var(--line)}.hero-bg{position:absolute;inset:0;z-index:-2;background:url("{{ $heroImageUrl }}") center/cover no-repeat;filter:saturate(1.04) contrast(1.03)}.hero-bg:after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,0,0,.76) 0%,rgba(0,0,0,.40) 52%,rgba(0,0,0,.70) 100%),linear-gradient(180deg,rgba(0,0,0,.18) 0%,rgba(0,0,0,.20) 48%,rgba(0,0,0,.88) 100%),linear-gradient(135deg,color-mix(in srgb,var(--brand) 28%,transparent),transparent 58%)}.hero-inner{display:grid;grid-template-columns:minmax(0,.92fr) minmax(300px,.48fr);gap:34px;align-items:end;padding:60px 0 32px}.team-main{animation:fadeUp .65s ease both}.back{display:inline-flex;align-items:center;gap:8px;color:var(--muted);font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;margin-bottom:18px}.identity{display:flex;align-items:center;gap:18px;margin-bottom:20px}.identity-logo{width:72px;height:72px;object-fit:contain}.identity-league{width:64px;height:64px;object-fit:contain;margin-left:auto}.label{font-family:var(--heading);font-size:12px;line-height:1;letter-spacing:.24em;text-transform:uppercase;font-weight:900;color:var(--brand-readable);margin-bottom:8px}.team-name{font-family:var(--heading);font-size:clamp(44px,7vw,96px);line-height:.88;letter-spacing:.015em;text-transform:uppercase;font-weight:900;text-shadow:0 16px 38px rgba(0,0,0,.38)}.team-copy{margin:18px 0 0;max-width:620px;color:rgba(255,255,255,.82);font-size:15px;line-height:1.55;font-weight:750}.hero-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:22px}.hero-actions .btn{height:44px}.team-facts{display:grid;gap:1px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.12);animation:fadeUp .65s ease both .12s}.fact{display:grid;grid-template-columns:36px 1fr;gap:12px;align-items:center;background:rgba(5,5,6,.72);padding:16px 18px;backdrop-filter:blur(16px)}.fact i{color:var(--brand-readable);font-size:17px;text-align:center}.fact span{display:block;color:var(--muted);font-size:10px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;margin-bottom:4px}.fact strong{display:block;font-family:var(--heading);font-size:18px;line-height:1.04;text-transform:uppercase;letter-spacing:.02em}
        .section{padding:42px 0;border-bottom:1px solid var(--line)}.section-head{display:flex;align-items:end;justify-content:space-between;gap:20px;margin-bottom:18px}.eyebrow{font-family:var(--heading);font-size:11px;font-weight:900;letter-spacing:.24em;text-transform:uppercase;color:var(--brand-readable);margin-bottom:6px}.section-title{font-family:var(--heading);font-size:clamp(30px,4vw,54px);line-height:.92;text-transform:uppercase;font-weight:900;letter-spacing:.02em}.roster-tools{display:flex;align-items:center;gap:10px;color:var(--muted);font-size:11px;font-weight:850;text-transform:uppercase;letter-spacing:.12em}.saved-strip{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:14px}.saved-pill{border:1px solid var(--line);background:var(--soft);padding:8px 10px;font-size:11px;font-weight:850;color:var(--muted)}.roster{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.player-row{position:relative;width:100%;border:1px solid var(--line);background:#0d0d10;color:#fff;text-align:left;display:grid;grid-template-columns:68px 1fr auto;align-items:center;gap:14px;padding:10px;cursor:pointer;overflow:hidden}.player-row:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,color-mix(in srgb,var(--brand) 15%,transparent),transparent 50%);opacity:.65}.player-row>*{position:relative;z-index:2}.player-row:hover{border-color:var(--brand-readable);transform:translateY(-1px)}.avatar{width:58px;height:58px;object-fit:cover;border-radius:999px;background:rgba(255,255,255,.09);display:grid;place-items:center;font-family:var(--heading);font-size:22px;font-weight:900;color:#fff;overflow:hidden}.avatar.card-img{border-radius:6px;object-fit:cover}.player-name{font-family:var(--heading);font-size:22px;line-height:1;text-transform:uppercase;font-weight:900;letter-spacing:.04em}.player-meta{display:flex;gap:8px;flex-wrap:wrap;margin-top:7px;color:var(--muted);font-size:11px;font-weight:850}.player-num{font-family:var(--heading);font-size:28px;line-height:1;font-weight:900;color:var(--brand-readable);text-align:right}.player-save-mini{font-size:10px;color:var(--muted);margin-top:6px;font-weight:900;text-transform:uppercase}.empty{grid-column:1/-1;padding:28px;background:#0d0d10;border:1px solid var(--line);color:var(--muted);text-align:center;font-weight:850}
        ...
        .player-overlay{position:fixed;inset:0;z-index:2100;display:none;background:rgba(0,0,0,.78);backdrop-filter:blur(16px)}.player-overlay.is-open{display:block}.player-panel{position:absolute;top:0;right:0;width:min(100%,520px);height:100%;background:#050506;box-shadow:-24px 0 70px rgba(0,0,0,.5);transform:translateX(100%);animation:panelIn .24s ease forwards;overflow:hidden}.player-panel-bar{position:relative;z-index:100;height:56px;display:flex;align-items:center;justify-content:space-between;padding:0 12px;background:#050506;border-bottom:1px solid var(--line)}.player-panel-title{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:var(--heading);font-size:18px;text-transform:uppercase;font-weight:900;letter-spacing:.08em}.player-panel-btn{height:36px;border:0;background:rgba(255,255,255,.08);color:#fff;padding:0 12px;font-family:var(--heading);font-size:12px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;cursor:pointer}.player-dialog{position:relative;z-index:1;height:calc(100% - 56px);overflow:auto;background:#050506;padding:0 0 20px}.player-nav-arrow{position:absolute;z-index:80;top:48%;transform:translateY(-50%);width:42px;height:56px;border:0;background:rgba(0,0,0,.72);color:#fff;display:grid;place-items:center;cursor:pointer}.player-nav-arrow:hover{background:var(--brand);color:var(--brand-on)}.player-nav-arrow.is-left{left:10px}.player-nav-arrow.is-right{right:10px}
        .mobile-card{position:relative;z-index:2;width:min(430px,100%);min-height:690px;margin:0 auto;background:var(--brand);color:#fff;overflow:hidden;font-family:var(--heading)}.mobile-card.has-override{min-height:auto;background:#000}.mobile-override-img{width:100%;height:auto}.mobile-bg-number{position:absolute;left:8px;top:182px;font-family:"Iceberg",sans-serif;font-size:240px;line-height:.8;letter-spacing:-18px;color:rgba(255,255,255,.10);z-index:1}.mobile-logo{position:absolute;top:18px;right:18px;z-index:4;max-width:54px;max-height:54px;object-fit:contain}.mobile-name{position:relative;z-index:5;padding:58px 20px 0;width:62%}.mobile-jersey{font-size:40px;line-height:.9;font-weight:800}.mobile-first{font-size:50px;line-height:.9;font-weight:900;text-transform:uppercase;letter-spacing:-.05em}.mobile-last{font-size:58px;line-height:.85;font-weight:900;text-transform:uppercase;letter-spacing:-.055em}.mobile-pos{margin-top:10px;font-size:23px;line-height:1;font-weight:800;text-transform:uppercase}.mobile-signature{position:absolute;left:20px;top:278px;z-index:1;font-family:"Luxurious Script",cursive;font-size:96px;color:rgba(255,255,255,.16);transform:rotate(-7deg)}.mobile-player-stage{position:absolute;right:-18px;top:122px;z-index:3;width:64%;height:360px;display:flex;align-items:flex-end;justify-content:center;pointer-events:none}.mobile-player-stage img{height:100%;width:auto;max-width:none;object-fit:contain;object-position:bottom center;filter:drop-shadow(0 14px 24px rgba(0,0,0,.24))}.mobile-info-grid{position:absolute;left:8px;right:8px;bottom:10px;z-index:8;display:grid;grid-template-columns:1fr 1fr;gap:8px}.mobile-stat{min-height:238px;background:#f2f2f2;color:#080808;padding:12px;border-radius:8px;overflow:hidden}.mobile-big-row{display:flex;align-items:flex-end;gap:5px;margin-bottom:14px}.mobile-big{font-size:76px;line-height:.78;font-weight:900;letter-spacing:-.06em}.mobile-big-label{font-size:22px;line-height:.9;font-weight:900;text-transform:uppercase;padding-bottom:8px}.mobile-org{display:grid;gap:12px}.mobile-org-row{display:grid;grid-template-columns:42px 1fr;align-items:center;gap:8px}.mobile-org-row img{width:40px;height:40px;object-fit:contain}.mobile-org-title{font-size:17px;line-height:.95;font-weight:900;text-transform:uppercase}.mobile-org-value{font-family:var(--body);font-size:11px;line-height:1.05;font-weight:800}.mobile-class-row{display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:12px;gap:4px}.mobile-class-year{font-size:66px;line-height:.78;font-weight:900;letter-spacing:-.055em}.mobile-class-label{font-size:22px;line-height:.9;font-weight:900;text-transform:uppercase;padding-bottom:8px}.mobile-meta{display:grid;gap:9px}.mobile-meta-row{display:grid;grid-template-columns:1fr auto;gap:8px;align-items:baseline}.mobile-meta-label{font-size:14px;line-height:1;font-weight:700;text-transform:uppercase}.mobile-meta-value{font-size:14px;line-height:1;font-weight:900;text-transform:uppercase;text-align:right}.player-actions{width:min(430px,100%);margin:10px auto 0;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.player-action{min-height:40px;border:1px solid var(--line);background:#0d0d10;color:#fff;display:flex;align-items:center;justify-content:center;gap:7px;padding:0 10px;font-family:var(--heading);font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.08em}.player-action.primary{background:var(--brand);color:var(--brand-on);border-color:var(--brand)}
        ...
        @media(max-width:900px){.frame,.wrap{width:100%}.nav{padding:0 16px}.nav-link{display:none}.hero{min-height:auto}.hero-inner{grid-template-columns:1fr;gap:18px;padding:78px 24px 0}.back{margin-bottom:14px}.identity{gap:12px;margin-bottom:18px}.identity-logo{width:52px;height:52px}.identity-league{width:52px;height:52px}.label{font-size:10px}.team-name{font-size:44px}.team-copy{font-size:14px;margin-top:14px}.team-facts{grid-template-columns:repeat(3,minmax(0,1fr));border-left:0;border-right:0;margin:30px -24px 0}.fact{display:block;padding:13px 14px}.fact i{font-size:14px;margin-bottom:10px}.fact span{font-size:8px}.fact strong{font-size:13px}.section{padding:34px 14px}.section-head{display:block}.roster-tools{margin-top:10px}.roster{grid-template-columns:1fr}.player-row{grid-template-columns:62px 1fr auto;gap:10px}.avatar{width:54px;height:54px}.player-name{font-size:19px}.player-num{font-size:23px}.player-panel{width:100%}.mobile-card{min-height:680px}.player-actions{padding:0 8px}.footer{padding:24px 18px}.nav-actions .btn{padding:0 12px;font-size:11px}}
...
<main class="site">
    <div class="frame">
        <nav class="nav">
            <a class="nav-brand" href="{{ $club?->landing_page_slug ? route('clubs.landing', ['clubSlug' => $club->landing_page_slug]) : '/' }}">
                @if($teamLogo)<img src="{{ $teamLogo }}" alt="{{ $team->name }} logo">@endif
                <span>{{ $team->name }}</span>
            </a>
        ...
        <div class="wrap hero-inner">
            <div class="team-main">
                ...
                <div class="identity">
                    ...
                    <div style="min-width:0"><div class="label">Team</div><h1 class="team-name">{{ $team->name }}</h1></div>
                ...
                <div class="hero-actions">
                    <button class="btn" type="button" data-open-coach><i class="fa-solid fa-user-tie"></i> Coach Info</button>
                    @if($coachPhone)<a class="btn" href="sms:{{ preg_replace('/\D+/', '', $coachPhone) }}"><i class="fa-solid fa-comment-dots"></i> Text Coach</a>@endif
                </div>
            </div>
    ...
    <section class="section" id="roster">
        <div class="wrap">
            <div class="section-head">
                ...
                <div class="roster-tools"><i class="fa-solid fa-arrow-down-1-9"></i> Sorted by number</div>
            </div>
...
<div class="player-overlay" id="playerOverlay" aria-hidden="true">
    <div class="player-panel">
        <div class="player-panel-bar"><div class="player-panel-title" id="playerPanelTitle">Player</div><button class="player-panel-btn" id="playerCloseBtn" type="button"><i class="fa-solid fa-xmark"></i> Close</button></div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    document.querySelectorAll('[data-close-coach]').forEach(btn => btn.addEventListener('click', () => { coachModal?.classList.remove('is-open'); coachModal?.setAttribute('aria-hidden','true'); }));
    ...
    function openPlayer(index){const player = dataAt(index); if(!player) return; active = index; title.textContent = player.name || 'Player'; dialog.innerHTML = render(player); overlay.classList.add('is-open'); overlay.setAttribute('aria-hidden','false'); document.body.style.overflow='hidden'; dialog.querySelectorAll('[data-open-coach]').forEach(btn => btn.addEventListener('click', () => { overlay.classList.remove('is-open'); coachModal?.classList.add('is-open'); }));}
    ...
    document.addEventListener('keydown', e => { if(e.key==='Escape'){closePlayer();coachModal?.classList.remove('is-open');} if(overlay?.classList.contains('is-open') && e.key==='ArrowRight') next(); if(overlay?.classList.contains('is-open') && e.key==='ArrowLeft') prev(); });
});
</script>
</body>
</html>