...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .hero{position:relative;isolation:isolate;min-height:clamp(620px, 76vh, 820px);display:grid;align-items:end;overflow:hidden;border-bottom:1px solid var(--line);background:#050506}
