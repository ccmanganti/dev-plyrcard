...
<section class="panel active" data-step="1">
  ...
  </div><div class="nav step-nav"><button type="button" class="btn pri" data-go="2">Continue</button></div><p class="tiny">Already have a PLYRCARD? <a href="/admin">Log in instead</a></p>
</section>
...
<section class="panel" data-step="4">
  ...
  <div class="nav step-nav"><button type="button" class="btn gho" data-go="3">Back</button><button type="button" class="btn pri" id="submitRegistration" disabled>Create my account</button></div>
</section>
