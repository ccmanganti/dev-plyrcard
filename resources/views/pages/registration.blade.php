...
<section class="panel" data-step="4">
  ...
  <div class="nav" id="paymentStartNav"><button type="button" class="btn gho" data-go="3">Back</button><button type="button" class="btn pri" id="submitRegistration">Continue to card payment</button></div>
</section>
