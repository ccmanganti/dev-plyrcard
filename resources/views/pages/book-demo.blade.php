...
<head>
  ...
  <meta name="description" content="Book a PLYRCARD demo — See how athletes can build a cleaner recruiting presence, share one link, and track coach engagement." />
  <title>Book a Demo — PLYRCARD</title>
...
<main>
  <section id="book-demo" aria-labelledby="book-demo-title">
    <div class="demo-shell">

      <div class="demo-copy">
        <p class="page-eyebrow reveal">Book a Demo</p>
        <h1 class="demo-title reveal" id="book-demo-title">
          See How<br>PLYRCARD<br><span>Works.</span>
        </h1>

        <p class="demo-lead reveal" style="transition-delay:0.08s">
          Get a guided look at how PLYRCARD helps athletes turn scattered recruiting details into one clean, coach-ready profile built to be shared, remembered, and tracked.
        </p>
        ...
        <div class="demo-points" aria-label="What the demo covers">
          <div class="demo-point reveal" style="transition-delay:0.12s">
            ...
            <div>
              <h2 class="point-title">Walk Through the Card</h2>
              <p class="point-copy">See how highlights, stats, schedule, academics, images, and athlete story come together in one polished link.</p>
            </div>
          </div>
          ...
          <div class="demo-point reveal" style="transition-delay:0.18s">
            ...
            <div>
              <h2 class="point-title">Understand the Outreach</h2>
              <p class="point-copy">Learn how athletes can send a stronger first impression instead of another generic recruiting email.</p>
            </div>
          </div>
          ...
          <div class="demo-point reveal" style="transition-delay:0.24s">
            ...
            <div>
              <h2 class="point-title">Track Coach Interest</h2>
              <p class="point-copy">Preview how engagement signals help athletes and families follow up with more confidence and better timing.</p>
            </div>
          </div>
        </div>
      ...
      <aside class="calendar-card reveal" style="transition-delay:0.16s" aria-label="Book a PLYRCARD demo calendar">
        <iframe src="https://systems.plyrcard.com/widget/booking/SvuQy1svAyETQ5Q9px9l" style="width: 100%;border:none;overflow: hidden;" scrolling="no" id="SvuQy1svAyETQ5Q9px9l_1777039204715"></iframe><br><script src="https://systems.plyrcard.com/js/form_embed.js" type="text/javascript"></script>
      </aside>
