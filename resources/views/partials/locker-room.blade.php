                ...
                <section class="lr-view is-active" data-lr-view="home">
                    <div class="lr-section">
                        ...
                        <div class="lr-menu-grid">
                            ...
                            <button class="lr-menu-card" type="button" data-lr-nav="billing"><span class="lr-menu-icon"><i class="fa-solid fa-credit-card"></i></span><span class="lr-menu-copy"><strong>Billing</strong><small>Plan, payments and billing address</small></span></button>
