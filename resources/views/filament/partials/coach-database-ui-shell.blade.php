<link rel="stylesheet" href="{{ asset('css/recruiting-center-ui.css') }}?v=20260710-favorite-close-tombstone-1">
...
<div id="rc-ui-instant-shell" wire:ignore aria-hidden="true" data-kind="drawer" data-rc-modal="loading" data-rc-modal-id="instant-shell">
    <button type="button" class="rc-ui-shell-backdrop" data-rc-shell-close aria-label="Close loading view" style="position:absolute;inset:0;border:0;background:transparent;cursor:default"></button>
    <section class="rc-ui-shell-panel" role="dialog" aria-modal="true" aria-label="Loading details">
        <header class="rc-ui-shell-head">
            ...
            <button type="button" class="rc-ui-shell-close" data-rc-shell-close aria-label="Close">×</button>
        </header>
...
<script src="{{ asset('js/recruiting-center-ui.js') }}?v=20260710-favorite-close-tombstone-1" defer></script>