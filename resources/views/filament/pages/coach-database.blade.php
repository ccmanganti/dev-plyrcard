...
@media(max-width:1180px){.rc-template-grid-v50{grid-template-columns:repeat(2,minmax(0,1fr))}.rc-template-editor-layout-v50{grid-template-columns:1fr}}
        ...
        <style>
            /* v75: instant school drawer feedback while Livewire resolves selectedSchool. */
            .rc-school-opening-backdrop-v75 {
                z-index: 89 !important;
                justify-content: flex-end !important;
                align-items: stretch !important;
            }
            .rc-school-opening-panel-v75 {
                display: grid;
                align-content: start;
                gap: 1rem;
                animation: rcSchoolOpeningSlideV75 .16s ease-out both;
                pointer-events: none;
            }
            @keyframes rcSchoolOpeningSlideV75 {
                from { transform: translateX(22px); opacity: .72; }
                to { transform: translateX(0); opacity: 1; }
            }
            .rc-school-opening-hero-v75 {
                display: grid;
            ...
            .rc-school-opening-logo-v75 { width:4.2rem; height:4.2rem; display:block; border-radius:1rem; }
            .rc-school-opening-copy-v75 { display:grid; gap:.48rem; }
            .rc-school-opening-line-v75 { width:70%; height:.72rem; display:block; }
            .rc-school-opening-line-v75.is-short { width:28%; height:.6rem; }
            .rc-school-opening-line-v75.is-title { width:55%; height:1.25rem; }
            .rc-school-opening-status-v75 {
                display:flex; align-items:center; gap:.5rem; color:var(--rc-muted);
                font-size:.8rem; font-weight:700; padding:.2rem 0;
            }
            .rc-school-opening-actions-v75 { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:.55rem; }
            .rc-school-opening-action-v75 { height:2.65rem; display:block; border-radius:.72rem; }
            .rc-school-opening-body-v75 { display:grid; gap:.65rem; padding-top:.4rem; }
            .rc-school-opening-row-v75 { height:4.25rem; display:block; border-radius:.85rem; }
        </style>

        {{-- Immediate Discover Schools drawer feedback.
             The real drawer depends on selectedSchool, which is only available after
             the selectSchoolById Livewire request completes. Keep a lightweight shell
             mounted at all times so the interaction responds on the same click. --}}
        <div
            class="rc-drawer rc-school-modal-backdrop rc-school-opening-backdrop-v75"
            wire:loading.flex
            wire:target="selectSchoolById"
            aria-hidden="true"
        >
            <div class="rc-drawer-panel rc-school-modal-panel rc-school-opening-panel-v75">
                <div class="rc-school-opening-hero-v75">
                    <span class="rc-school-opening-logo-v75 rc-skeleton"></span>
                    <div class="rc-school-opening-copy-v75">
                        <span class="rc-school-opening-line-v75 is-short rc-skeleton"></span>
                        <span class="rc-school-opening-line-v75 is-title rc-skeleton"></span>
                        <span class="rc-school-opening-line-v75 rc-skeleton"></span>
                    </div>
                </div>
                <div class="rc-school-opening-status-v75">
                    <span class="rc-spinner-mini"></span>
                    <span>Opening school</span>
                </div>
                <div class="rc-school-opening-actions-v75">
                    <span class="rc-school-opening-action-v75 rc-skeleton"></span>
                    <span class="rc-school-opening-action-v75 rc-skeleton"></span>
                    <span class="rc-school-opening-action-v75 rc-skeleton"></span>
                </div>
                <div class="rc-school-opening-body-v75">
                    <span class="rc-school-opening-row-v75 rc-skeleton"></span>
                    <span class="rc-school-opening-row-v75 rc-skeleton"></span>
                    <span class="rc-school-opening-row-v75 rc-skeleton"></span>
                </div>
            </div>
