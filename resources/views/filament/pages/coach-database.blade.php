...
(() => {
    if (window.__plyrRcInstantSpaNavV130) return;
    window.__plyrRcInstantSpaNavV130 = true;
    ...
    // Do not prevent the click. Filament SPA / wire:navigate owns navigation.
    // This block only gives immediate visual feedback while the destination renders.
    document.addEventListener('click', (event) => {
